/* ===== Cricket SA Academy — client-side AI assistant (self-contained, no backend) ===== */
(function(){
  if(window.__aiwLoaded)return; window.__aiwLoaded=1;
  var css=
  ".aiw-btn{position:fixed;right:20px;bottom:20px;z-index:300;display:inline-flex;align-items:center;gap:9px;background:#026637;color:#fff;border:0;border-radius:30px;padding:12px 18px;font:600 14px/1 Inter,-apple-system,Segoe UI,sans-serif;cursor:pointer;box-shadow:0 16px 36px -14px rgba(0,161,198,.6)}"+
  ".aiw-btn:hover{background:#014d29}.aiw-btn svg{width:18px;height:18px}.aiw-btn .dot{width:7px;height:7px;border-radius:50%;background:#ffcc07}"+
  ...
  ".aiw-head .av{width:36px;height:36px;border-radius:9px;background:linear-gradient(135deg,#026637,#0a713b);display:grid;place-items:center}.aiw-head .av svg{width:19px;height:19px}"+
  ...
  ".aiw-msg.me{background:#026637;color:#fff;align-self:flex-end;border-bottom-right-radius:4px}"+
  ".aiw-msg.bot a{color:#014d29;font-weight:700}.aiw-msg.bot b{color:#1c1c1f}"+
  ".aiw-cards{display:flex;flex-direction:column;gap:7px;align-self:flex-start;max-width:94%}"+
  ".aiw-card{display:block;background:#fff;border:1px solid #dfe7ea;border-left:3px solid #026637;border-radius:10px;padding:9px 12px;text-decoration:none}.aiw-card:hover{border-color:#026637}"+
  ...
  ".aiw-chip{background:#fff;border:1px solid #dfe7ea;border-radius:30px;padding:7px 11px;font:600 12px Inter,sans-serif;color:#2b2b2b;cursor:pointer}.aiw-chip:hover{border-color:#026637;color:#014d29}"+
  ".aiw-foot{display:flex;gap:8px;padding:10px 12px;border-top:1px solid #dfe7ea;background:#fff;flex:0 0 auto}"+
  ".aiw-foot input{flex:1;border:1px solid #dfe7ea;border-radius:9px;padding:10px 12px;font:14px Inter,sans-serif;color:#2b2b2b}.aiw-foot input:focus{outline:2px solid #026637}"+
  ".aiw-foot button{background:#026637;border:0;color:#fff;border-radius:9px;padding:0 14px;cursor:pointer;line-height:0}.aiw-foot button:hover{background:#014d29}.aiw-foot button svg{width:18px;height:18px}"+
  ...
  function reply(q){
    ...
    if(has("price","pricing","cost","fee","how much","rate","quote","afford","pay","free")) return [T("Nothing — every course is <b>fully funded by Cricket SA</b>. You just need to <a href='contact'>register your interest</a> and square the timing with your line manager."),CH(["Register my interest"])];
